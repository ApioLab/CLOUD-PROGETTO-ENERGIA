...
angular.module("ApioApplication").controller("ApioHomeController", ["$scope", "socket", "boardsService", "objectService", "currentObject", "$routeParams", "$location", "$timeout", "sharedProperties", "$http", "$window", "$rootScope", "sweet", "$mdDialog", function ($scope, socket, boardsService, objectService, currentObject, $routeParams, $location, $timeout, sharedProperties, $http, $window, $rootScope, sweet, $mdDialog) {
