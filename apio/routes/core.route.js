...
module.exports = function (Apio) {
    return {
        ...
        getWifiCurrentSSID: function (req, res) {
        ...
        switchWifiStatus: function (req, res) {
        ...
        getWifiStatus: function (req, res) {
        ...
        launchPropertiesAdder: function (req, res) {
            exec("cd ./services && node apio_properties_adder.js" + (req.body.objectId ? " --objectId " + req.body.objectId : ""), function (error, stdout, stderr) {
                if (error || stderr) {
                    res.status(500).send(error || stderr);
                } else {
                    res.status(200).send(stdout);
